    ...
    if (a(window).width() > b) {
        ...
        a(window).on("scroll", {
            ...
            function () {
                ...
                if(b>0){
                    a('.navbar-custom').addClass('is-fixed is-visible');
                }else{
                    a('.navbar-custom').removeClass('is-fixed is-visible');
                }
                // b < this.previousTop ?
                // b > 0 && a(".navbar-custom").hasClass("is-fixed") ?
                //     a(".navbar-custom").addClass("is-visible") : a(".navbar-custom").removeClass("is-visible is-fixed") :
                // (a(".navbar-custom").removeClass("is-visible"), b > c && !a(".navbar-custom").hasClass("is-fixed") && a(".navbar-custom").addClass("is-fixed")),
                // this.previousTop = b
